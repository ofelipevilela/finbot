...
https://ofelipevilela.github.io/my-fin-assistant-1
...
Após o cadastro, você poderá usar todos os recursos do bot! 🤖💰`,
  ...
  COMMANDS: {
    EXPENSE: ['gastei', 'gasto', 'paguei', 'pago', 'comprei', 'comprado', 'perdi', 'perda'],
    INCOME: ['recebi', 'receita', 'salário', 'salario', 'vendi', 'ganhei'],
